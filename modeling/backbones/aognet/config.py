...
# _C.aognet.filter_list = [56, 224, 448, 896, 1400] ############### try to keep 1:4:2:2 ... except for the final stage which can be adusted for fitting the model size
# _C.aognet.out_channels = [0,0]
# _C.aognet.blocks = [2, 2, 3, 1]
# _C.aognet.dims = [2, 2, 4, 4]
# _C.aognet.max_split = [2, 2, 2, 2]
# _C.aognet.extra_node_hierarchy = [4, 4, 4, 4] # 0: none, 1: tnode topdown, 2: tnode bottomup layerwise, 3: tnode bottomup sequential, 4: or-node lateral connection, 5: tnode bottomup
# _C.aognet.remove_symmetric_children_of_or_node = [1, 2, 1, 2] # if true, aog structure is much simplified and bigger filters and more units can be used
# _C.aognet.terminal_node_no_slice = [0, 0, 0, 0]
# _C.aognet.stride = [1, 2, 2, 2]
# _C.aognet.drop_rate = [0.0, 0.0, 0.1, 0.1]
# _C.aognet.bottleneck_ratio = 0.25
# _C.aognet.handle_dbl_cnt = True
# _C.aognet.handle_tnode_dbl_cnt = False
# _C.aognet.handle_dbl_cnt_in_param_init = False
# _C.aognet.use_group_conv = False
# _C.aognet.width_per_group = 0
# _C.aognet.when_downsample = 1
# _C.aognet.replace_stride_with_avgpool = False # in shortcut
