...
OUTPUT_DIR "('/root/data/reid/NAIC/output/')" DATASETS.QUERY_DIR "('query_a')" DATASETS.GALLERY_DIR "('gallery_a')" \
DATASETS.ROOT_DIR "('/root/share/dataset/reid')" MODEL.PRETRAIN_CHOICE "('self')" \
TEST.WEIGHT "('/root/data/reid/NAIC/output/Experiment-se_resnet101_ibn_a_stage_1/se_resnet101_ibn_a_model_80.pth')"  TEST.TEST_MODEL "stage_1_se_resnet101_80" 
