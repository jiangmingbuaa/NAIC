...
# python3 tools/train.py --config_file='configs/softmax_triplet.yml' MODEL.DEVICE_ID "('0,1,2')" MODEL.NAME "('resnet50_ibn_a_ha')" \
# MODEL.PRETRAIN_PATH "('/root/share/pretrained_models/r50_ibn_a.pth')" \
# OUTPUT_DIR "('/root/data/reid/NAIC/output/Experiment-resnet50_ibn_a')" \
# MODEL.METRIC_LOSS_TYPE "('triplet_oim')"  MODEL.IF_LABELSMOOTH "('off')"  ### oim loss
...
# OUTPUT_DIR "('/home/jiangming/re-id/NAIC/reid_strong_baseline/output/Experiment-resnext101_ibn_a')" \
# MODEL.METRIC_LOSS_TYPE "('triplet_oim')"  MODEL.IF_LABELSMOOTH "('off')"  ### oim loss
...
OUTPUT_DIR "('/home/jiangming/re-id/NAIC/reid_strong_baseline/output/Experiment-se_resnet101_ibn_a')" \
MODEL.METRIC_LOSS_TYPE "('triplet_oim')"  MODEL.IF_LABELSMOOTH "('off')"  ### oim loss
