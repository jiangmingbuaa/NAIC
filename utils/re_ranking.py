...
def re_ranking(probFea, galFea, k1=20, k2=6, lambda_value=0.3, MemorySave = True, Minibatch = 2000):
...
def re_ranking(probFea, galFea, k1, k2, lambda_value, local_distmat=None, only_local=False, MemorySave = True, Minibatch = 5000):
