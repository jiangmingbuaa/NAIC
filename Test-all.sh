...
python3 tools/test.py --config_file='configs/softmax_triplet.yml' MODEL.DEVICE_ID "('4')" MODEL.NAME "('se_resnet101_ibn_a')" DATASETS.NAMES "('NAIC')"  \
OUTPUT_DIR "('/root/data/reid/NAIC/output/')" \
DATASETS.ROOT_DIR "('/root/share/dataset/reid')" MODEL.PRETRAIN_CHOICE "('self')" \
TEST.WEIGHT "('/root/data/reid/NAIC/output/Experiment-se_resnet101_ibn_a/se_resnet101_ibn_a_model_100.pth')" \
TEST.RE_RANKING "('yes')" # re-ranking
...
# python3 tools/test.py --config_file='configs/softmax_triplet.yml' MODEL.DEVICE_ID "('6')" MODEL.NAME "('resnet50_ibn_a')" DATASETS.NAMES "('NAIC')"  \
# OUTPUT_DIR "('/root/data/reid/NAIC/output/')" \
# DATASETS.ROOT_DIR "('/root/share/dataset/reid')" MODEL.PRETRAIN_CHOICE "('self')" \
# TEST.WEIGHT "('/root/data/reid/NAIC/output/Experiment-resnet50_ibn_a/resnet50_ibn_a_model_80.pth')" \
# TEST.RE_RANKING "('yes')" # re-ranking